...
**Author:** Md. Istiak Hussain Adil (ID: 0562220005101053)
...
deep-learning/
├── lab/
│   ├── task-1/         # NumPy, Pandas, Scikit-Learn notebooks
│   ├── task-2/         # Simple neural network implementations
│   ├── ANN/            # Artificial Neural Network (Iris dataset)
│   └── CNN/            # Convolutional Neural Network (MNIST dataset)
├── theory/
│   ├── mid/            # Mid-term notes & exercise questions
│   └── final/          # Final exam notes
└── project/            # SmartGrid Sentinel (course project)
```
